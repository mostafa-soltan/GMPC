...
class SearchController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        $files = File::allFiles(app()->basePath() . self::DS . 'app' . self::DS . 'Models');
        ...
        return view('user.pages.search', compact('results'));
    }
    ...
    private function resolveModelViewLink(Model $model)
    {
        ...
        $mapping = [
            \App\Models\Lnew::class => '/' . $modelName . '/single_new/{new}',
        ];
