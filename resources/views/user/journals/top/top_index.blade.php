                    ...
                    <article>
                        <div>
                            ...
                            <ul class="list-unstyled pl-3">
                                ...
                                <li><strong>Abbreviation: </strong>GMPC TOP </li>
                        ...
                        <div>
                            ...
                            <p class="pl-3">
                                The GMPC Platform for Theses and Opinions (ISSN {{ $journal->issn }}) is an international,
                                scientific, peer-reviewed journal on sciences published issuely online by GMPC,
                                German Multidisciplinary Publishing Center. The journal publishes ideas in sciences,
                                scientific opinions, critical theoretical articles, and thesis summaries that promote
                                the diversity and debate upon which the scientific process thrives. The <strong><em>GMPC
                                        TOP</em></strong> is covering all aspects of scientific research. The journal
                                will accept two types of articles and has restrictions on the length of manuscripts. All
                                manuscripts are peer-reviewed, and a first decision provided to authors approximately
                                three weeks after submission. Submitted papers to the <strong><em>GMPC TOP</em></strong>
                                journal should neither be published previously nor be under consideration for
                                publication in another journal and website.
                            </p>
                        </div>
                        <div>
                            <h5 class="head pl-2">Peer review process</h5>
                            <p class="pl-3">
                                The peer review process is a critical factor for high quality of scientific research.
                                The <strong><em>GMPC TOP</em></strong> uses a double-blind review process. Manuscripts
                                suitable for review will be reviewed by at least two expert reviewers selected by the
                                Editor-in-Chief. All manuscripts are peer-reviewed, and a first decision provided to
                                authors approximately three weeks after submission.
                            </p>
                        </div>
                        <div>
                            <h5 class="head pl-2">English language editing</h5>
                            <p class="pl-3">
                                English language editing will be done by expert/editors after receipt of the article
                                processing charge. However, the manuscript must be of good quality English at the time
                                of submission. The English language editing will be done free of cost.
                            </p>
                        </div>
                    </article>
                </div>
