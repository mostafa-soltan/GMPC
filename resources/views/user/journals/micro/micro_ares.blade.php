                    ...
                    <article>
                        ...
                        <div>
                            ...
                            <ul>
                                ...
                                <li>For manuscript preparation please use <a
                                        href="{{asset('ui-assets')}}/resourses/Ger.-J.-Microbiol.-Author-Guidlines.pdf"
                                        download="Ger.-J.-Microbiol.-Author-Guidlines.pdf">GMPC author Guidelines.</a>
                                </li>
                                <li>For submission, please register yourself with GMPC and <a
                                        href="https://www.ejmanager.com/my/gjm/index.php" target="blank">log in </a>to the
                            ...
                            <ul>
                                <li>Accepted manuscripts will be adapted according to the GMPC style. Figures, images,
                                    and tables of high quality will be used <a
                                        href="{{asset('ui-assets')}}/resourses/Ger.-J.-Microbiol.-Author-Guidlines.pdf"
                                        download="Ger.-J.-Microbiol.-Author-Guidlines.pdf">(Authors
                                        Guidelines).</a> Proofs
                        ...
                        <div>
                            ...
                            <ul>
                                ...
                                <li><strong>Email:</strong> <a href="mailto:editor-gjm@gmpc-akademie.de"
                                                               target="blank">editor-gjm@gmpc-akademie.de </a></li>
                            </ul>
                        </div>
                        <div class="downloads">
                            <h5 class="head pl-2">Downloads</h5>
                            <div class="d-flex text-center font-weight-bold">
                                <a href="../ui-assets/resourses/Ger.-J.-Microbiol.-Author-Guidlines.pdf"
                                   download="Ger. J. Microbiol. Author Guidlines.pdf" target="blank">
                                    <img src="https://cdn.fileinfo.com/img/icons/files/128/pdf-74.png" alt="pdf icon">
                                    <p>ATHOR <br> GUIDLINES</p>
                                </a>
                                <a href="../ui-assets/resourses/GJM-Template.docx">
                                    <img src="https://cdn.fileinfo.com/img/icons/apps/128/microsoft_word.png"
                                         alt="word icon">
                                    <p>GJM WORD <br> TEMPLATE</p>
                                </a>
                                <a href="../ui-assets/resourses/Application-for-APC-waiver.docx">
                                    <img src="https://cdn.fileinfo.com/img/icons/apps/128/microsoft_word.png"
                                         alt="word icon">
                                    <p>APC WAIVER <br> REQUEST</p>
                                </a>
                                <a href="../ui-assets/resourses/GMPC-Endnote-Style.ens">
