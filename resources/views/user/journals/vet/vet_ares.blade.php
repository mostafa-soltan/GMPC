                    ...
                    <ul class="navbar-nav m-auto align-items-center">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item active" href="{{ route('ares', $journal->abbreviation) }}">Author resources</a>
                    ...
                    <article>
                        ...
                        <div>
                            ...
                            <ul>
                                ...
                                <li>For manuscript preparation please use <a
                                        href="{{ asset('ui-assets') }}/resourses/Ger.-J-Vet.-Res.-Author-Guidelines.pdf"
                                        download="Ger. J Vet. Res. Author Guidelines.pdf">GMPC author Guidelines.</a>
                                </li>
                                <li>For submission, please register yourself with GMPC and <a
                                        href="https://www.ejmanager.com/my/gjvr/index.php" target="blank">log in </a>to the
                                    editorial system to
                                    start submission.</li>
                            </ul>
                        </div>
                            ...
                            <ul>
                                <li>Accepted manuscripts will be adapted according to the GMPC style. Figures, images,
                                    and tables of high quality will be used <a
                                        href="{{ asset('ui-assets') }}/resourses/Ger.-J-Vet.-Res.-Author-Guidelines.pdf"
                                        download="Ger. J Vet. Res. Author Guidelines.pdf">(Authors
                                        Guidelines).</a> Proofs
                        ...
                        <div>
                            ...
                            <ul>
                                ...
                                <li><strong>Email:</strong> <a href="mailto:editor-gjvr@gmpc-akademie.de"
                                                               target="blank">editor-gjvr@gmpc-akademie.de</a></li>
                            </ul>
                        </div>
                        <div class="downloads">
                            <h5 class="head pl-2">Downloads</h5>
                            <div class="d-flex text-center font-weight-bold">
                                <a href="{{ asset('ui-assets') }}/resourses/Ger.-J-Vet.-Res.-Author-Guidelines.pdf"
                                   download="Ger. J Vet. Res. Author Guidelines.pdf" target="blank">
                                    <img src="https://cdn.fileinfo.com/img/icons/files/128/pdf-74.png" alt="pdf icon">
                                    <p>ATHOR <br> GUIDLINES</p>
                                </a>
                                <a href="{{ asset('ui-assets') }}/resourses/GJVR-Template.docx">
                                    <img src="https://cdn.fileinfo.com/img/icons/apps/128/microsoft_word.png"
                                         alt="word icon">
                                    <p>GJVR WORD <br> TEMPLATE</p>
                                </a>
