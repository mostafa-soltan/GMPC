...
@section('content')
    @include('admin.users.partials.header', ['title' => __('Edit New')])
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('lnews.update', $lnews) }}" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="title" id="input-title" class="form-control form-control-alternative{{ $errors->has('title') ? ' is-invalid' : '' }}" placeholder="{{ __('Title') }}" value="{{ $lnews->title }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('author') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="author" id="input-author" class="form-control form-control-alternative{{ $errors->has('author') ? ' is-invalid' : '' }}" placeholder="{{ __('Author') }}" value="{{ $lnews->author }}" required>
                                ...
                                <div class="form-group{{ $errors->has('publish_date') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="date" name="publish_date" id="input-publish_date" class="form-control form-control-alternative{{ $errors->has('publish_date') ? ' is-invalid' : '' }}" placeholder="{{ __('Publish Date') }}" value="{{ $lnews->publish_date }}" required>
