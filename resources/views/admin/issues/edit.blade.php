...
@section('content')
    @include('admin.users.partials.header', ['title' => __('Edit Issue')])
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('issues.update', $issue) }}" autocomplete="off">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('issue_no') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="issue_no" id="input-issue_no" class="form-control form-control-alternative{{ $errors->has('issue_no') ? ' is-invalid' : '' }}" placeholder="{{ __('Issue No.') }}" value="{{ $issue->issue_no }}" required autofocus>
