...
@section('content')
    @include('admin.users.partials.header', ['title' => __('Add Editor')])
                        ...
                        <form method="post" action="{{ route('editors.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('affiliation') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="affiliation" id="input-affiliation" class="form-control form-control-alternative{{ $errors->has('affiliation') ? ' is-invalid' : '' }}" placeholder="{{ __('Affiliation') }}" value="{{ old('affiliation') }}" required>
