...
@section('content')
    @include('admin.users.partials.header', ['title' => __('Edit Volume')])
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('volumes.update', $volume) }}" autocomplete="off">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('volume_no') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="volume_no" id="input-volume_no" class="form-control form-control-alternative{{ $errors->has('volume_no') ? ' is-invalid' : '' }}" placeholder="{{ __('Volume No.') }}" value="{{ $volume->volume_no }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('year') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="year" id="input-year" class="form-control form-control-alternative{{ $errors->has('year') ? ' is-invalid' : '' }}" placeholder="{{ __('Year') }}" value="{{ $volume->year }}" required>
